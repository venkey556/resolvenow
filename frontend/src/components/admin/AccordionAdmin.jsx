...
const AccordionAdmin = () => {
  ...
  return (
    <div>
      <Accordion style={{backgroundColor:'051129'}} className='accordian' alwaysOpen>
        <Accordion.Item eventKey="0">
          <Accordion.Header>Users Complaints</Accordion.Header>
          <Accordion.Body style={{background:'#051129'}}>
            <div style={{ display: "flex", flexWrap: "wrap", margin: "20px",  }}>
              {complaintList.length > 0 ? (
                complaintList.map((complaint, index) => (
                  <Card key={index} style={{ width: '15rem', margin: '0 10px 15px 0', border: '2px solid aqua',
                    borderRadius:'10px',
                    boxShadow:'0 0 5px green, 0 0 20px yellowgreen, 0 0 yellowgreen, 0 0 50px yellowgreen, 0 0 10px yellowgreen', color: 'white', backgroundColor:'#051129' }}>
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body style={{background:'#051129'}}>
            <div style={{ display: "flex", flexWrap: "wrap", margin: "20px" }}>
              {agentList.length > 0 ? (
                agentList.map((agent, index) => (
                  <Card key={index} style={{ width: '22rem', margin: '0 10px 15px 0', border: '2px solid aqua',
                    borderRadius:'10px',
                    boxShadow:'0 0 5px green, 0 0 20px yellowgreen, 0 0 yellowgreen, 0 0 50px yellowgreen, 0 0 10px yellowgreen', color:'white', backgroundColor:'#051129'}}>
                    <Card.Body>
